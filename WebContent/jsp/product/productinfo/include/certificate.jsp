...
<div class="row">
	<div id="tableContainer" class="col-12" style="display: none;">
		<table id="tableResult-1" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer" cellspacing="0" width="100%">
			<thead>
				<tr>
					...
					<th data-name="contractEmail" data-orderable="false"><s:text name="prd.contractMail"/></th>
					<th data-name="docExpireDate" data-orderable="false"><s:text name="prd.expireDate"/></th>
