...
public class ProductDialogManager extends AbstractManager<ProductDialogSearchCriteria, CommonDomain, CommonDomain, CommonUser>{

	private ProductDialogService service;
	
	public ProductDialogManager(CCTConnection conn, CommonUser user, Logger log) {
		super(conn, user, log);
		this.service = new ProductDialogService(conn, user, log);
	}

	@Override
	public List<CommonDomain> search(ProductDialogSearchCriteria criteria) throws Exception {
